...
class ShopfloorService(object):
  ...
  def NotifyStart(self, data, station):
    ...
    logging.info('DUT %s Entering station %s', data.get(KEY_MLB_SERIAL_NUMBER),
                 station)
    return {
            'component.sku': data.get(SKU_ID),
            'component.dram.part_num': 'K4F6E3S4HM'
    }
  ...
  def GetDeviceInfo(self, data):
    ...
    return {'vpd.ro.region': 'us',
            'vpd.rw.ubind_attribute': '=CisKILvhJI_tgFC9Q0Kesf4wNL2JNIbCwstrRb1hUb7VM206EAEaBW1hcGxlEPq2rrUH',
            'vpd.rw.gbind_attribute': '=CisKIMIUAIU363iTN0rHK9o-GlDMsBiUcVNwrdVygTD2lgVwEAAaBW1hcGxlENisvqYF'}
